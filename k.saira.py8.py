...
def toggle_eyes():
    ...
    c.itemconfigute(eye_right, fill=new_color)
...
b=ody = c.create_oval(35,20, 365, 350, outline=c.body_color,fill=c.body_color)
...
foot_left = c.create_oval(65, 320, 145, 360,outline=c.body_color,
                          fill= c.body_color)
foot_right= c.create_oval(250, 320, 330, 360,outline=c.body_color,
                         fill= c.body_color)
